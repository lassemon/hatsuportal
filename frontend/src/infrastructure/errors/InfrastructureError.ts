export type InfrastructureErrorInput = string | Error | { message?: string; cause?: unknown } | undefined

/**
 * Base class for all custom infrastructure exceptions.
...
export class InfrastructureError extends Error {
  ...
  constructor(input?: InfrastructureErrorInput, defaultMessage = 'Infrastructure error') {
    /* ------------------------------------------------------------------ *
