...
import { PostHttpClient } from 'infrastructure/http/clients/PostHttpClient'
...
import { PreferencesHttpClient } from 'infrastructure/http/clients/PreferencesHttpClient'
...
export class HttpClientFactory implements IHttpClientFactory {
  ...
  createPostHttpClient(): IPostHttpClient {
    return new PostHttpClient(this.httpClient)
  }
  ...
  createPreferencesHttpClient(): IPreferencesHttpClient {
    return new PreferencesHttpClient(this.httpClient)
  }
