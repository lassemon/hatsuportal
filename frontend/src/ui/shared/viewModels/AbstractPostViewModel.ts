...
export interface AbstractPostViewModelDTO {
  readonly id: string
...
export abstract class AbstractPostViewModel<E extends AbstractPostViewModelDTO> {
  ...
  abstract toJSON(): AbstractPostViewModelDTO
  abstract clone(props?: Partial<E>): AbstractPostViewModel<E>
  ...
  public getBaseProps(): AbstractPostViewModelDTO {
    return {
      id: this._id,
  ...
  public equals(other: unknown): boolean {
    return (
      other instanceof AbstractPostViewModel &&
      this._id === other.id &&
