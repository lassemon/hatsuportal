...
import { AbstractPostViewModel, AbstractPostViewModelDTO } from 'ui/entities/post/model/AbstractPostViewModel'
import { EntityLoadErrorDTO } from '@hatsuportal/contracts'
import { TagViewModel, TagViewModelDTO } from '../../tag/model/TagViewModel'
...
export class PostViewModel<Model extends PostViewModelDTO> extends AbstractPostViewModel<Model> {
  ...
  private _imageLoadError: EntityLoadErrorDTO | null
  ...
  public get imageLoadError(): EntityLoadErrorDTO | null {
