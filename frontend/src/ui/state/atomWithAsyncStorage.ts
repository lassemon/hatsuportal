...
export const atomWithAsyncStorage = <T extends unknown>(key: string, initialValue: T, parsers?: AsyncStorageParsers<T>) => {
  console.log('atomWithAsyncStorage alsdkhjakjhfa', errorAtom)
  console.log('atomWithAsyncStorage aDSJASDLKJASLDJALJ', LocalStorageService)
  console.log('atomWithAsyncStorage :AS:SRTJDSLJADLkjs', isPromise)
  console.log('atomWithAsyncStorage :"AMC:KASDFLKJAFDA"', StorageParseError)
