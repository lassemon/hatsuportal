import { AppBar, Avatar, Box, Divider, IconButton, Menu, Toolbar, useMediaQuery, useTheme } from '@mui/material'
...
import ColorModeSwitch from 'ui/shared/ui/ColorModeSwitch'
...
const NavBar: React.FC = () => {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      >
        <Toolbar disableGutters sx={{ paddingRight: '1.5em' }}>
          <Box
            sx={{
              display: 'flex',
              alignItems: 'center',
              margin: isSmall ? '0' : '0 1.5em',
