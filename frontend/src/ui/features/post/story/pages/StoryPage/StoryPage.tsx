...
import { ViewStoryLayout } from 'ui/features/post/story/layouts/ViewStoryLayout'
...
const StoryPage: React.FC = () => {
  ...
  const [{ story, backendStory, loadingStory }, setStory] = useStory(entityServiceContext.storyService, urlStoryId, {
    persist: true
  })
