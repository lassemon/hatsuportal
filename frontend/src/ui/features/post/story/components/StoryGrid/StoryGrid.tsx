...
import TinyPostCard from 'ui/features/post/common/components/TinyPostCard'
      ...
      >
        {loading
          ...
          : stories.map((story, index) => {
              return (
                <Fragment key={`${story.id}-${index}`}>
                  <TinyPostCard post={story} onClick={() => redirectToStory(story)} />
                </Fragment>
              )
            })}
      </Box>
