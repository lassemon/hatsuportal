...
import useDefaultPage from 'presentation/hooks/useDefaultPage'
...
import PageSection from 'presentation/components/PageSection'
import UserCreationDates from 'presentation/components/UserCreationDates'
  ...
  const onChangePassword = () => {
    if (user && validatePasswordChange()) {
      ...
      const passwordUpdate = {
        id: authState.user?.id!, // user in this page is never undefined
