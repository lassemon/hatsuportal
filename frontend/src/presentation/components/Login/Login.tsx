...
import LoginDialog from 'presentation/components/LoginDialog'
import { useAtom } from 'jotai'
import { authAtom } from 'application/state/atoms/authAtom'
import { scheduleAsyncFunction } from 'application/utils/utils'
import _ from 'lodash'
import { uuid } from '@hatsuportal/common'
import { useOrientation } from 'presentation/hooks/useOrientation'
import { UserPresentationDTO } from '@hatsuportal/presentation'
import { useAuthServiceContext } from 'infrastructure'
...
const Login: React.FC = () => {
  ...
  useEffect(() => {
    ...
    scheduleAsyncFunction(
      statusCheck,
      60000, // TODO replace magic number with config
  ...
  const handleLoginSuccess = (successResponse: UserPresentationDTO) => {
