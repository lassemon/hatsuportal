...
export const isBoolean = (arg: unknown) => isBooleanLodash(arg)
export const isString = (arg: unknown): arg is string => isStringLodash(arg)
export const isNumber = (arg: unknown): arg is number => isNumberLodash(arg)
