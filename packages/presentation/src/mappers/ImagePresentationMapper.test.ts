...
describe('ImagePresentationMapper', () => {
  ...
  it('converts image dto to response', ({ unitFixture }) => {
    ...
    expect(imageMapper.toResponse(unitFixture.imageDTO())).toStrictEqual(unitFixture.imageResponse())
  })

  it('converts image response to ImagePresentation entity', ({ unitFixture }) => {
    expect(imageMapper.toImagePresentationDTO(unitFixture.imageResponse())).toStrictEqual(unitFixture.imageDTO())
  })
})
