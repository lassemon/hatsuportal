...
export class ImagePresentation extends PostPresentation<ImagePresentationDTO> {
  ...
  constructor(props: ImagePresentationDTO) {
    ...
    if (!isString(props.fileName)) {
      throw new InvalidPresentationPostValueError(`Property "fileName" must be a string, was '${props.fileName}'`)
    }
    this._fileName = props.fileName

    if (!isString(props.mimeType)) {
      throw new InvalidPresentationPostValueError(`Property "mimeType" must be a string, was '${props.mimeType}'`)
    }
    this._mimeType = props.mimeType

    if (!isNumber(props.size)) {
      throw new InvalidPresentationPostValueError(`Property "size" must be a number, was '${props.size}'`)
    }
    this._size = props.size

    if (!isString(props.ownerId)) {
      throw new InvalidPresentationPostValueError(`Property "ownerId" must be a string, was '${props.ownerId}'`)
    }
    this._ownerId = props.ownerId

    if (!isEnumValue(props.ownerType, PostTypeEnum)) {
      throw new InvalidPresentationPostValueError(`Property "ownerType" must be one of ${PostTypeEnum}, was '${props.ownerType}'`)
    }
    this._ownerType = props.ownerType

    if (!isString(props.base64)) {
      throw new InvalidPresentationPostValueError(`Property "base64" must be a string, was '${props.base64}'`)
    }
  ...
  public set fileName(fileName: string) {
    if (!isString(fileName)) {
      throw new InvalidPresentationPostValueError(`Property "fileName" must be a string, was '${fileName}'`)
    }
  ...
  public set mimeType(mimeType: string) {
    if (!isString(mimeType)) {
      throw new InvalidPresentationPostValueError(`Property "mimeType" must be a string, was '${mimeType}'`)
    }
  ...
  public set ownerId(ownerId: string) {
    if (!isString(ownerId)) {
      throw new InvalidPresentationPostValueError(`Property "ownerId" must be a string or null, was '${ownerId}'`)
    }
  ...
  public set ownerType(ownerType: PostTypeEnum) {
    if (!isEnumValue(ownerType, PostTypeEnum)) {
      throw new InvalidPresentationPostValueError(`Property "ownerType" must be one of ${PostTypeEnum}, was '${ownerType}'`)
    }
  ...
  public set base64(base64: string) {
    if (!isString(base64)) {
      throw new InvalidPresentationPostValueError(`Property "base64" must be a string, was '${base64}'`)
    }
