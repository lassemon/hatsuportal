...
export abstract class PostPresentation<E extends PostPresentationProps> {
  ...
  constructor(props: E) {
    ...
    if (!isEnumValue(props.visibility, VisibilityEnum)) {
      throw new InvalidPresentationPostValueError(`Property "visibility" must be one of ${VisibilityEnum}, was '${props.visibility}'`)
    }
    ...
    if (!isNumber(props.updatedAt) && props.updatedAt !== null) {
      throw new InvalidPresentationPostValueError(`Property "updatedAt" must be a number or null, was '${props.updatedAt}'`)
    }
  ...
  set visibility(visibility: VisibilityEnum) {
    if (!isEnumValue(visibility, VisibilityEnum)) {
      throw new InvalidPresentationPostValueError(`Property "visibility" must be one of ${VisibilityEnum}, was '${visibility}'`)
    }
  ...
  set updatedAt(updatedAt: number | null) {
    if (!isNumber(updatedAt) && updatedAt !== null) {
      throw new InvalidPresentationPostValueError(`Property "updatedAt" must be a number or null, was '${updatedAt}'`)
    }
