...
import type { IDomainEventHolder, UnixTimestamp } from '@hatsuportal/shared-kernel'
import { ITransactionContext, ITransactionScope, RollbackCallback } from '../../application'
...
export class NodeAsyncLocalTransactionContext implements ITransactionContext {
  ...
  public addEventHolders(holders: Array<IDomainEventHolder | null>): void {
