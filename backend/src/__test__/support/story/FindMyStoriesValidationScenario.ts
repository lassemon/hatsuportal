import { IFindMyStoriesUseCase, FindStoryInputDTO } from '@hatsuportal/post-management'
import { FindMyStoriesUseCaseWithValidation } from '../../../application/useCases/story/FindMyStoriesUseCase'
