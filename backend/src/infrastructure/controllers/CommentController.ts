...
export class CommentController extends RootController {
  ...
  public async editComment(
    ...
    try {
      const editCommentInput = this.commentApiMapper.toEditCommentInputDTO(editCommentRequest, commentId, request.user?.id)
  ...
  public async deleteComment(
    ...
    try {
      const deleteCommentInput = this.commentApiMapper.toDeleteCommentInputDTO(commentId, request.user?.id)
