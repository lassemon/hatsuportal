...
export class StoryController extends RootController {
  ...
  constructor() {
    super()
    this.storyApiMapper = tsyringeContainer.resolve<IStoryApiMapper>('IStoryApiMapper')
  }
  ...
  public async search(
    ...
    try {
      const searchStoriesInput = this.storyApiMapper.toStorySearchCriteriaDTO(searchStoriesRequest)
  ...
  public async create(
    ...
    try {
      this.validateAuthentication(request)
      const createStoryInput = this.storyApiMapper.toCreateStoryInputDTO(createStoryRequest)
  ...
  public async update(
    ...
    try {
      this.validateAuthentication(request)
      const updateStoryInput = this.storyApiMapper.toUpdateStoryInputDTO(updateStoryRequest, storyId)
  ...
  public async delete(
    ...
    try {
      this.validateAuthentication(request)
      const deleteStoryInput = this.storyApiMapper.toDeleteStoryInputDTO(storyId)
