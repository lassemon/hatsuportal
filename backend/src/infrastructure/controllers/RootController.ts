...
export class RootController extends Controller {
  public static readonly authentication: IAuthentication = tsyringeContainer.resolve<IAuthentication>('IAuthentication')
  ...
  constructor() {
    ...
    this.useCaseFactory = tsyringeContainer.resolve<IUseCaseFactory>('IUseCaseFactory')
    this.httpErrorMapper = tsyringeContainer.resolve<IHttpErrorMapper>('IHttpErrorMapper')
  }

  validateAuthentication(request: TsoaRequest): asserts request is TsoaRequest & { user: UserDTO } {
