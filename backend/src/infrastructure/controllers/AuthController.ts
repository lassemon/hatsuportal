...
export class AuthController extends RootController {
  ...
  constructor() {
    super()
    this.userApiMapper = container.resolve<IUserApiMapper>('IUserApiMapper')
    this.userApplicationMapper = container.resolve<IUserApplicationMapper>('IUserApplicationMapper')
    this.authApiMapper = container.resolve<IAuthApiMapper>('IAuthApiMapper')
  }
