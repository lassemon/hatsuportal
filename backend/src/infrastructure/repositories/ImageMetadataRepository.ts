...
import { DataPersistenceError, IImageMetadataRepository, NotFoundError } from '@hatsuportal/application'

const logger = new Logger('ImageRepository')

export class ImageMetadataRepository implements IImageMetadataRepository {
