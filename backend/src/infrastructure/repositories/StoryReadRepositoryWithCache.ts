import { ITransaction, OrderEnum, StorySortableKeyEnum } from '@hatsuportal/foundation'
import { IStoryReadRepository, StorySearchCriteriaDTO, PostCreatorId, PostId, StoryReadModelDTO } from '@hatsuportal/post-management'

export class StoryReadRepositoryWithCache implements IStoryReadRepository {
  constructor(private readonly baseRepo: IStoryReadRepository, private readonly cache: Map<string, StoryReadModelDTO | null>) {}
