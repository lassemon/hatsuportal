...
import { IUserRepository, Password, User, IUserCredentials, UserId, UserName } from '@hatsuportal/user-management'

export class UserRepositoryWithCache implements IUserRepository, ITransactionAware {
  constructor(private readonly baseRepo: IUserRepository & ITransactionAware, private readonly cache: Map<string, User | null>) {}
