...
import { ITransactionAware, NotFoundError } from '@hatsuportal/platform'
import { unixtimeNow } from '@hatsuportal/common'

export class CommentWriteRepository extends Repository implements ICommentWriteRepository, ITransactionAware {
