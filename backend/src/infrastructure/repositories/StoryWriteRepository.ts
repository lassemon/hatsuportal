...
import { EntityTypeEnum, ImageRoleEnum, Logger, unixtimeNow } from '@hatsuportal/common'
import { ConcurrencyError, DataPersistenceError, NotFoundError, ITransactionAware, ITransaction } from '@hatsuportal/platform'

const logger = new Logger('StoryWriteRepository')

export class StoryWriteRepository extends Repository implements IStoryWriteRepository, ITransactionAware {
