...
import { Comment, CommentId, ICommentWriteRepository } from '@hatsuportal/post-management'

export class CommentWriteRepositoryWithCache implements ICommentWriteRepository {
  constructor(private readonly baseRepo: ICommentWriteRepository, private readonly cache: Map<string, Comment | null>) {}
