...
import { isEnumValue, Logger, OrderEnum, StorySortableKeyEnum, VisibilityEnum } from '@hatsuportal/common'
import { ITransactionAware } from '@hatsuportal/platform'

const logger = new Logger('StoryReadRepository')

export class StoryReadRepository extends Repository implements IStoryReadRepository, ITransactionAware {
