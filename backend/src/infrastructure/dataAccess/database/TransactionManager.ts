...
export class TransactionManager implements ITransactionManager {
  ...
  async execute<T extends IDomainEventHolder>(work: () => Promise<T>, repositories: IRepository[] = []): Promise<T> {
   ...
   */
  private async flushDomainEvents(eventHolder: IDomainEventHolder): Promise<IDomainEventHolder> {
