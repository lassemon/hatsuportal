 ...
 * NOTE: If you make changes to this file, reflect them in the platform package TestKnexQueryBuilder.ts as well!
 */
export class KnexQueryBuilder<TRecord extends {} = any> implements IQueryBuilder<TRecord> {
  ...
  forUpdate(): IQueryBuilder<TRecord> {
    return new KnexQueryBuilder(this.knexQuery.forUpdate())
  }
