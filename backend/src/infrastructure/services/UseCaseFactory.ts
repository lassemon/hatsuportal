...
export type IUseCaseFactory = IPostUseCaseFactory & IUserUseCaseFactory & IMediaUseCaseFactory & IThemeUseCaseFactory
 ...
 */
export class UseCaseFactory implements IPostUseCaseFactory, IUserUseCaseFactory, IMediaUseCaseFactory, IThemeUseCaseFactory {
  constructor(
    ...
    private readonly themeUseCaseFactory: IThemeUseCaseFactory
  ) {}
  ...
  createSearchPostsUseCase(): ISearchPostsUseCase {
    return this.postUseCaseFactory.createSearchPostsUseCase()
  }
  ...
  createGetUserPreferencesUseCase(): IGetUserPreferencesUseCase {
    return this.userUseCaseFactory.createGetUserPreferencesUseCase()
  }

  createUpdateUserProfileUseCase(): IUpdateUserProfileUseCase {
    return this.userUseCaseFactory.createUpdateUserProfileUseCase()
  }

  createUpdateUserPreferencesUseCase(): IUpdateUserPreferencesUseCase {
    return this.userUseCaseFactory.createUpdateUserPreferencesUseCase()
  }

  // theme
  createListThemesUseCase(): IListThemesUseCase {
    return this.themeUseCaseFactory.createListThemesUseCase()
  }

  createCreateThemeUseCase(): ICreateThemeUseCase {
    return this.themeUseCaseFactory.createCreateThemeUseCase()
  }

  createUpdateThemeUseCase(): IUpdateThemeUseCase {
    return this.themeUseCaseFactory.createUpdateThemeUseCase()
  }

  createDeleteThemeUseCase(): IDeleteThemeUseCase {
    return this.themeUseCaseFactory.createDeleteThemeUseCase()
  }
}
