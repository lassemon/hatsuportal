import { ErrorHandlingUseCaseDecorator, IDomainEventService, IUnitOfWork } from '@hatsuportal/platform'
import {
  AddCommentUseCase,
...
export class PostUseCaseFactory implements IPostUseCaseFactory {
  ...
  constructor(
    ...
    this.storyCoverImageCleanupService = new StoryCoverImageCleanupService(
