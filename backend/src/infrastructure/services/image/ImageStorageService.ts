// TODO, pass generic storage to replace path and fs and move this file to boundedContext/mediaManagement ?

import path from 'path'
import { promises as fs } from 'node:fs'
import sanitize from 'sanitize-filename'
import { BASE64_PNG_PREFIX, DataPersistenceError, Logger, NotFoundError } from '@hatsuportal/foundation'
import { IImageStorageService } from '@hatsuportal/media-management'
