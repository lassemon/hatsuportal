...
import { UnreferencedImageCleaner } from '../services/UnreferencedImageCleaner'
...
export class CleanupOrphanImagesJob implements ICronJob {
  ...
  constructor(
    ...
    private readonly unreferencedImageCleaner: UnreferencedImageCleaner,
  ...
  private async onTick(): Promise<void> {
    try {
      ...
      await this.unreferencedImageCleaner.cleanUnreferencedImages()
    } catch (error) {
