export type ApplicationErrorInput = string | Error | { message?: string; cause?: unknown } | undefined
...
export class ApplicationError extends Error {
  ...
  constructor(input?: ApplicationErrorInput, defaultMessage = 'Application error') {
    /* ------------------------------------------------------------------ *
