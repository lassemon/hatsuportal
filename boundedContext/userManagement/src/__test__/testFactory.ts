...
import { EntityLoadResult, IDomainEventService, IUnitOfWork } from '@hatsuportal/platform'
...
export const unitOfWorkMock = (domainEventServiceMock: Mocked<IDomainEventService>): IUnitOfWork<UserId, UnixTimestamp> => {
  class UnitOfWorkMock implements IUnitOfWork<UserId, UnixTimestamp> {
