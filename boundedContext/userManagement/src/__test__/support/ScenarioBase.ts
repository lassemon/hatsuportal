...
> {
  ...
  protected readonly postGateway = Fixture.postGatewayMock()
  ...
  // THEN helpers
  // ───────────────────────────────────────────────────────────────────
  thenDomainEventsPersisted(eventHolders: IDomainEventHolder<UserId, UnixTimestamp>[]) {
  ...
  thenDomainEventsNotPersisted(eventHolders: IDomainEventHolder<UserId, UnixTimestamp>[]) {
    this.ensureExecutionCompleted()
    this.ensureNoUnexpectedError()
