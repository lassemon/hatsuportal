...
> {
  protected readonly userWriteRepository = Fixture.userWriteRepositoryMock()
  protected readonly userReadRepository = Fixture.userReadRepositoryMock()
  protected readonly userLookupService = Fixture.userLookupServiceMock()
