...
export class UserRole extends ValueObject<UserRoleEnum> {
  static SuperAdmin = new UserRole(UserRoleEnum.SuperAdmin)
  static Admin = new UserRole(UserRoleEnum.Admin)
  static Creator = new UserRole(UserRoleEnum.Creator)
  static Editor = new UserRole(UserRoleEnum.Editor)
  static Viewer = new UserRole(UserRoleEnum.Viewer)
  static Moderator = new UserRole(UserRoleEnum.Moderator)
