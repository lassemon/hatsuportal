...
import { DomainEvent, DomainEventHolder, UnixTimestamp } from '@hatsuportal/common-bounded-context'
...
import { UserCreatedEvent, UserDeactivatedEvent, UserUpdatedEvent } from '../events/UserEvents'
...
export class User implements DomainEventHolder {
