...
export class User extends Entity implements IDomainEventHolder<UserId, UnixTimestamp> {
  ...
  public rename(name: UserName, updatedById: string, emitEvents: boolean = true): void {
    this._name = name
  ...
  public changeEmail(email: Email, updatedById: string, emitEvents: boolean = true): void {
    this._email = email
    this._updatedAt = new UnixTimestamp(unixtimeNow())
    if (emitEvents)
      this.addDomainEvent(
  ...
  public changeRoles(roles: UserRole[], updatedById: string, emitEvents: boolean = true): void {
  ...
  public activate(activatedById: string, emitEvents: boolean = true): void {
    this._active = true
    this._updatedAt = new UnixTimestamp(unixtimeNow())
    if (emitEvents)
      this.addDomainEvent(
        new UserUpdatedEvent({
          ...
          email: this.email.value,
          updatedAt: this.updatedAt.value,
          updatedById: activatedById
        })
      )
  }

  public deactivate(deactivatedById: string, emitEvents: boolean = true): void {
    this._active = false
    this._updatedAt = new UnixTimestamp(unixtimeNow())
    if (emitEvents)
      this.addDomainEvent(
  ...
  public override delete(deletedById: string): void {
    this._updatedAt = new UnixTimestamp(unixtimeNow())
    this.addDomainEvent(
