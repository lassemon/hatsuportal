...
import { IUnitOfWork, IDomainEventService, ITransactionContext, ITransactionScope, flattenDomainEventsFromHolders } from '@hatsuportal/platform'
...
export { sampleUserId, sampleImageId, sampleImageVersionId, sampleImageStorageKey }

export const sampleNonAuthorUserId = 'b2c3d4e5-f6a7-4890-b123-456789abcdef'
export const sampleCurrentVersionId = '3a4b5c6d-7e8f-4678-d901-234567abcdef'
