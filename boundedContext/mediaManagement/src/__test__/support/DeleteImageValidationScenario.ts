...
import { IDeleteImageUseCase, IDeleteImageUseCaseOptions, DeleteImageUseCaseWithValidation } from '../../application'
import { ImageValidationScenarioBase } from './ImageValidationScenarioBase'

export class DeleteImageValidationScenario extends ImageValidationScenarioBase<IDeleteImageUseCaseOptions, 'imageDeleted'> {
  static given() {
