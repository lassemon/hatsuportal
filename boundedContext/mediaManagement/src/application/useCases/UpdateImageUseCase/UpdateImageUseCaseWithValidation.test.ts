import { DeepPartial } from '@hatsuportal/foundation'
...
import { AuthenticationError, NotFoundError, AuthorizationError, InvalidInputError } from '@hatsuportal/foundation'
