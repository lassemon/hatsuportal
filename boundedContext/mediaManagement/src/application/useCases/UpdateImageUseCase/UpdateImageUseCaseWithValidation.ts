...
import { UseCaseWithValidation } from '@hatsuportal/foundation'
import { IUpdateImageUseCase, IUpdateImageUseCaseOptions } from './UpdateImageUseCase'
import { IImageRepository } from '../../repositories/IImageRepository'
import { AuthenticationError, NotFoundError, AuthorizationError } from '@hatsuportal/foundation'
import { Base64Image, FileSize, Image, ImageId, MimeType } from '../../../domain'
    ...
    return (
      ...
      ((base64 ?? null) !== null
        ? this.testArgument<'updateImageInput'>('updateImageInput', options, (updateImageInput) => {
            ...
            Base64Image.canCreate(base64, undefined, { throwError: true })
            return true
          })
        : true)
    )
