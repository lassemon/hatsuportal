...
import { castToEnum, EntityTypeEnum, ImageRoleEnum } from '@hatsuportal/foundation'
...
export class ImageStorageKey extends ValueObject<string> {
  ...
  constructor(
    ...
    this.value = `${stagedPrefix}${entityType}_${role}_${ownerEntityId}_${versionId}_${createdById}.${fileExtension}`
  }
