...
import { IDomainEventService, ITransactionAware, ITransactionManager } from '@hatsuportal/platform'
import { CreateStoryRequest, SearchStoriesRequest, StoryResponse, UpdateStoryRequest } from '@hatsuportal/contracts'
...
export const transactionManagerMock = (domainEventServiceMock: Mocked<IDomainEventService>): ITransactionManager<PostId, UnixTimestamp> => {
  class TransactionManagerMock implements ITransactionManager<PostId, UnixTimestamp> {
    execute = async <T extends Array<IDomainEventHolder<PostId, UnixTimestamp> | null>>(
      work: () => Promise<[...T]>,
