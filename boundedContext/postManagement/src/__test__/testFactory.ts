...
import { IDomainEvent, ImageMetadataDatabaseSchema } from '@hatsuportal/common-bounded-context'
import { Mocked, vi } from 'vitest'
import { StoryDatabaseSchema } from '../infrastructure/schemas/StoryDatabaseSchema'
import { IStoryRepository, Recipe, Story } from '../domain'
...
export const recipeDTOMock = () => {
  return {
    ...{
      id: 'test1b19-recipe-4792-a2f0-f95ccab82d92',
      visibility: VisibilityEnum.Public,
      createdById: USER_ID,
      createdByName: 'testUserName',
      createdAt,
...
export const recipeMock = (): Recipe => {
  return Recipe.create(recipeDTOMock())
}
