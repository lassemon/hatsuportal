...
import { IGetRepliesUseCase, IGetRepliesUseCaseOptions } from '../../../application/useCases/comment/GetRepliesUseCase/GetRepliesUseCase'

export class GetRepliesValidationScenario extends CommentValidationScenarioBase<IGetRepliesUseCaseOptions, 'repliesFound'> {
  static given() {
