...
import { StoryImageLinkDatabaseSchema } from '../schemas/StoryImageLinkDatabaseSchema'
...
import { ImageRoleEnum, PartialExceptFor, validateAndCastEnum, VisibilityEnum } from '@hatsuportal/foundation'
...
export interface IStoryInfrastructureMapper {
  ...
  toImageLinkRow(story: Story): Omit<StoryImageLinkDatabaseSchema, 'createdAt'> | null
