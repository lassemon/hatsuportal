...
export class CommentReadRepositoryWithCache implements ICommentReadRepository {
  constructor(
    private readonly baseRepo: ICommentReadRepository,
  ...
  invalidateById(id: CommentId): void {
    this.cache.delete(`getById:${id.value}`)
  }
}
