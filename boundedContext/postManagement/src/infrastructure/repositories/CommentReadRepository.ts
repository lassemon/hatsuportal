...
export class CommentReadRepository extends RepositoryBase implements ICommentReadRepository {
  constructor(
  ...
  async getById(id: CommentId): Promise<CommentReadModelDTO | null> {
  ...
  invalidateById(_id: CommentId): void {
