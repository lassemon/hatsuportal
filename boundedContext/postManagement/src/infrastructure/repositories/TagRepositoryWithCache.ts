...
export class TagRepositoryWithCache implements ITagRepository {
  constructor(
    private readonly baseRepo: ITagRepository,
  ...
  async findByIdForUpdate(tagId: TagId): Promise<Tag | null> {
    return await this.baseRepo.findByIdForUpdate(tagId)
  }
