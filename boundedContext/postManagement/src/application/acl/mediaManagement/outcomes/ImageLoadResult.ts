...
export class ImageLoadResult<T, E = ImageLoadError> {
  ...
  static failedToLoad(imageId: string, error: Error): ImageLoadResult<never, ImageLoadError> {
    return new ImageLoadResult<never, ImageLoadError>(undefined, new ImageLoadError({ imageId, error }))
  }
