...
import { CoverImageRemovedFromStoryEvent, StoryDeletedEvent } from '../../../../domain'
...
describe('DeleteStoryUseCase', () => {
  ...
  it('should delete a story with image successfully and persist expected domain events', async ({ unitFixture }) => {
    ...
    scenario
      ...
      .thenDomainEventsPersisted([expect.any(StoryDeletedEvent), expect.any(CoverImageRemovedFromStoryEvent)])
  })
  ...
  it('should delete a story without image and dispatch only StoryDeletedEvent', async ({ unitFixture }) => {
    ...
    scenario
      ...
      .thenDomainEventsNotPersisted([expect.any(CoverImageRemovedFromStoryEvent)])
  })
  ...
  it('should not call output boundary, not send domain events and rollback transaction when repository fails', async ({ unitFixture }) => {
    ...
    scenario
      ...
      .thenDomainEventsNotPersisted([expect.any(StoryDeletedEvent), expect.any(CoverImageRemovedFromStoryEvent)])
  })
