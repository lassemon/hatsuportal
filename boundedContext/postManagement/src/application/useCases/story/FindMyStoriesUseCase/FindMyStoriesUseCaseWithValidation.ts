import { UseCaseWithValidation, AuthenticationError } from '@hatsuportal/platform'
...
{
  constructor(
    private readonly useCase: IFindMyStoriesUseCase,
  ...
  async execute(options: IFindMyStoriesUseCaseOptions): Promise<void> {
    ...
    if (loggedInUser.isFailed()) throw new AuthenticationError('Not logged in.')
