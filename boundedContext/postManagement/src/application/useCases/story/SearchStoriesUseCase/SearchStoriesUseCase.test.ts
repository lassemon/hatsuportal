...
import { OrderEnum, StorySortableKeyEnum, DeepPartial, UserRoleEnum } from '@hatsuportal/common'
...
describe('SearchStoriesUseCase', () => {
  ...
  it('should return all stories including private ones when superadmin is logged in and no filters defined', async ({ unitFixture }) => {
    ...
    scenario
      .thenStoryLookupServiceCalledTimes('findAll', 1)
      .thenStoryLookupServiceCalledTimes('findAllVisibleForLoggedInCreator', 0)
