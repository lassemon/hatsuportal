import { ImageStateEnum, validateAndCastEnum, VisibilityEnum } from '@hatsuportal/foundation'
...
// This class is not under any bounded context, because it shares cross domain concerns like User, Image, Tag, etc.
