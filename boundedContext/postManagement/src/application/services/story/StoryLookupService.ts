...
export interface IStoryLookupService {
  ...
  findAll(orderBy: StorySortableKeyEnum, order: OrderEnum): Promise<StoryWithRelationsDTO[]>
...
export class StoryLookupService implements IStoryLookupService {
  ...
  async findAll(orderBy: StorySortableKeyEnum, order: OrderEnum): Promise<StoryWithRelationsDTO[]> {
