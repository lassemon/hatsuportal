import { Entity, EntityProps, NonEmptyString, UnixTimestamp } from '@hatsuportal/shared-kernel'
import { IDomainEvent, Logger, unixtimeNow } from '@hatsuportal/foundation'
  ...
  static canCreate(props: any, { throwError = false }: CanCreateOptions = {}) {
    try {
      new Comment(
        ...
        props.postId instanceof PostId ? props.id : new PostId(props.postId),
        props.authorId instanceof CommentAuthorId ? props.authorId : new CommentAuthorId(props.authorId),
        props.body instanceof NonEmptyString ? props.body : new NonEmptyString(props.body),
        props.parentCommentId instanceof CommentId ? props.parentCommentId : new CommentId(props.parentCommentId),
        props.isDeleted,
