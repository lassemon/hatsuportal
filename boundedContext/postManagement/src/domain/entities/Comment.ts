import { CreatedAtTimestamp, Entity, EntityProps, IDomainEvent, NonEmptyString, UnixTimestamp } from '@hatsuportal/shared-kernel'
...
export class Comment extends Entity {
  ...
  public softDelete(deleteById: string): void {
    if (!this._isDeleted) {
  ...
  public delete(deleteById: string): void {
    if (!this._isDeleted) {
      this._isDeleted = true
      this._updatedAt = new UnixTimestamp(unixtimeNow())
      this.addDomainEvent(
