...
import { DomainEvent, DomainEventHolder, InvalidUnixTimestampError, UnixTimestamp } from '@hatsuportal/common-bounded-context'
...
export abstract class Post<E extends PostProps> implements DomainEventHolder {
