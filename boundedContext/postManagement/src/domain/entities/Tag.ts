...
import { CreatedAtTimestamp, EntityProps, InvalidUnixTimestampError, NonEmptyString, UnixTimestamp } from '@hatsuportal/shared-kernel'
...
export class Tag {
  ...
  private _createdAt: CreatedAtTimestamp
