...
export class Recipe extends Post {
  ...
  static assertCanCreate(props: any): void {
    new Recipe(
      ...
      props.description instanceof RecipeDescription ? props.description : new RecipeDescription(props.description),
  ...
  public updateDescription(description: RecipeDescription, updatedById: UniqueId): void {
    this._description = description
    this._updatedAt = new UnixTimestamp(unixtimeNow())
  }

  public get description(): RecipeDescription {
