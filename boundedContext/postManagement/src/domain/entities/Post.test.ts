...
import { uuid, unixtimeNow, VisibilityEnum } from '@hatsuportal/common'
import { CreatedAtTimestamp, DomainEvent, UnixTimestamp, InvalidCreatedAtTimestampError } from '@hatsuportal/shared-kernel'
...
class TestPost extends Post {
  constructor(props: PostProps) {
    super(props.id, props.title, props.visibility, props.createdById, props.createdAt, props.updatedAt)
  }
...
describe('Post (abstract) – shared behaviour', () => {
  ...
  it('throws InvalidCreatedAtTimestampError when createdAt is after updatedAt', () => {
    ...
    expect(() => new TestPost(invalidProps)).toThrow(InvalidCreatedAtTimestampError)
  })
