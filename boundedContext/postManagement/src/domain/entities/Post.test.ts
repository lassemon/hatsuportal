...
import { CreatedAtTimestamp, IDomainEvent, InvalidUnixTimestampError, NonEmptyString, UnixTimestamp } from '@hatsuportal/shared-kernel'
...
describe('Post (abstract) – shared behaviour', () => {
  ...
  beforeEach(() => {
    ...
    baseProps = {
      id: new PostId(uuid()),
      title: new NonEmptyString('Title'),
