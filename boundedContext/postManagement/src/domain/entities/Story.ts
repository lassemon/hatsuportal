...
export class Story extends Post {
  ...
  static assertCanCreate(props: any): void {
    new Story(
      ...
      new NonEmptyString(props.title),
      new PostVisibility(props.visibility),
      new NonEmptyString(props.body),
  ...
  public updateBody(body: NonEmptyString, updatedById: UniqueId): void {
    this._body = body
  ...
  public get body(): NonEmptyString {
    return this._body
  }
