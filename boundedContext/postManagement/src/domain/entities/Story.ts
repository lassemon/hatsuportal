...
export class Story extends Post {
  ...
  public rename(name: NonEmptyString, updatedById: UniqueId, emitEvents: boolean = true): void {
    this._name = name
  ...
  public updateVisibility(visibility: PostVisibility, updatedById: UniqueId, emitEvents: boolean = true): void {
    this._visibility = visibility
    this._updatedAt = new UnixTimestamp(unixtimeNow())
    if (emitEvents)
      this.addDomainEvent(
  ...
  public updateDescription(description: NonEmptyString, updatedById: UniqueId, emitEvents: boolean = true): void {
    this._description = description
    this._updatedAt = new UnixTimestamp(unixtimeNow())
    if (emitEvents)
      this.addDomainEvent(
  ...
  public updateCoverImage(newCoverImageId: CoverImageId, updatedBy: UniqueId, emitEvents: boolean = true): void {
  ...
  public setNewTags(tagIds: TagId[], updatedById: UniqueId, emitEvents: boolean = true): void {
    this._tagIds = tagIds
    this._updatedAt = new UnixTimestamp(unixtimeNow())
    if (emitEvents)
      this.addDomainEvent(
  ...
  public addTag(tagId: TagId, addedById: UniqueId, emitEvents: boolean = true): void {
  ...
  public removeTag(tagId: TagId, removedById: UniqueId, emitEvents: boolean = true): void {
  ...
  public delete(deletedById: string, emitEvents: boolean = true): void {
    this._updatedAt = new UnixTimestamp(unixtimeNow())
    if (emitEvents)
      this.addDomainEvent(
