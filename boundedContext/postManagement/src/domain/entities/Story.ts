...
import { DomainError, UnixTimestamp, UniqueId, CreatedAtTimestamp } from '@hatsuportal/shared-kernel'
import {
  StoryCreatedEvent,
...
export class Story extends Post {
  ...
  static assertCanCreate(props: any): void {
    new Story(
      ...
      props.title instanceof PostTitle ? props.title : new PostTitle(props.title),
      new PostVisibility(props.visibility),
      props.body instanceof StoryBody ? props.body : new StoryBody(props.body),
  ...
  static create(props: StoryProps): Story {
    ...
    if (!story.coverImageId.equals(CoverImageId.NOT_SET)) {
      story.addDomainEvent(
  ...
  public override rename(title: PostTitle, updatedById: UniqueId): void {
  ...
  public override updateVisibility(visibility: PostVisibility, updatedById: UniqueId): void {
    super.updateVisibility(visibility, updatedById)
    this.addDomainEvent(
  ...
  public updateBody(body: StoryBody, updatedById: UniqueId): void {
    this._body = body
  ...
  public updateCoverImage(newCoverImageId: CoverImageId, updatedBy: UniqueId): void {
    ...
    const coverImageReplaced = settingNewCoverImage && currentlyHasCoverImage && !this._coverImageId.equals(newCoverImageId)
  ...
  public override equals(other: unknown): boolean {
    return super.equals(other) && other instanceof Story && this.coverImageId.equals(other.coverImageId)
  }
}
