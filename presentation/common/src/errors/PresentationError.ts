export type PresentationErrorInput = string | Error | { message?: string; cause?: unknown } | undefined

/**
 * Base class for all custom presentation exceptions.
...
export class PresentationError extends Error {
  ...
  constructor(input?: PresentationErrorInput, defaultMessage = 'Presentation error') {
    /* ------------------------------------------------------------------ *
