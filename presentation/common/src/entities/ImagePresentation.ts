...
import { InvalidPresentationPropertyError } from '../errors/InvalidPresentationPropertyError'

export interface ImagePresentationDTO {
  readonly id: string
  fileName: string
  mimeType: string
...
export class ImagePresentation {
  ...
  constructor(props: ImagePresentationDTO) {
    ...
    if (!isString(props.fileName)) {
      throw new InvalidPresentationPropertyError(`Property "fileName" must be a string, was '${props.fileName}'`)
    }
    this._fileName = props.fileName

    if (!isString(props.mimeType)) {
      throw new InvalidPresentationPropertyError(`Property "mimeType" must be a string, was '${props.mimeType}'`)
    }
    this._mimeType = props.mimeType

    if (!isNumber(props.size)) {
      throw new InvalidPresentationPropertyError(`Property "size" must be a number, was '${props.size}'`)
    }
    this._size = props.size

    if (!isString(props.ownerEntityId)) {
      throw new InvalidPresentationPropertyError(`Property "ownerEntityId" must be a string, was '${props.ownerEntityId}'`)
    }
    this._ownerEntityId = props.ownerEntityId

    if (!isEnumValue(props.ownerEntityType, EntityTypeEnum)) {
      throw new InvalidPresentationPropertyError(
        `Property "ownerEntityType" must be one of ${EntityTypeEnum}, was '${props.ownerEntityType}'`
      )
    }
    this._ownerEntityType = props.ownerEntityType

    if (!isString(props.base64)) {
      throw new InvalidPresentationPropertyError(`Property "base64" must be a string, was '${props.base64}'`)
    }
    ...
    if (!isNumber(props.updatedAt) && props.updatedAt !== null) {
      throw new InvalidPresentationPropertyError(`Property "updatedAt" must be a number or null, was '${props.updatedAt}'`)
    }
  ...
  public set fileName(fileName: string) {
    if (!isString(fileName)) {
      throw new InvalidPresentationPropertyError(`Property "fileName" must be a string, was '${fileName}'`)
    }
  ...
  public set mimeType(mimeType: string) {
    if (!isString(mimeType)) {
      throw new InvalidPresentationPropertyError(`Property "mimeType" must be a string, was '${mimeType}'`)
    }
  ...
  public set ownerEntityId(ownerEntityId: string) {
    if (!isString(ownerEntityId)) {
      throw new InvalidPresentationPropertyError(`Property "ownerEntityId" must be a string, was '${ownerEntityId}'`)
    }
  ...
  public set ownerEntityType(ownerEntityType: EntityTypeEnum) {
    if (!isEnumValue(ownerEntityType, EntityTypeEnum)) {
      throw new InvalidPresentationPropertyError(`Property "ownerEntityType" must be one of ${EntityTypeEnum}, was '${ownerEntityType}'`)
    }
  ...
  public set base64(base64: string) {
    if (!isString(base64)) {
      throw new InvalidPresentationPropertyError(`Property "base64" must be a string, was '${base64}'`)
    }
  ...
  set updatedAt(updatedAt: number) {
    if (!isNumber(updatedAt)) {
      throw new InvalidPresentationPropertyError(`Property "updatedAt" must be a number, was '${updatedAt}'`)
    }
