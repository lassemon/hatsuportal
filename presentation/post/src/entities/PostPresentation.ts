...
export abstract class PostPresentation<E extends PostPresentationProps> {
  ...
  constructor(props: E) {
    ...
    if (!isEnumValue(props.visibility, VisibilityEnum)) {
      throw new InvalidPresentationPropertyError(`Property "visibility" must be one of ${VisibilityEnum}, was '${props.visibility}'`)
    }
  ...
  set visibility(visibility: VisibilityEnum) {
    if (!isEnumValue(visibility, VisibilityEnum)) {
      throw new InvalidPresentationPropertyError(`Property "visibility" must be one of ${VisibilityEnum}, was '${visibility}'`)
    }
