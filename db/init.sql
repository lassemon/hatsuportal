CREATE TABLE
  IF NOT EXISTS users (
    ...
    roles longtext CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(roles)),
...
CREATE TABLE
  IF NOT EXISTS images (
    ...
    size INT NOT NULL,
    ownerEntityId VARCHAR(255) NOT NULL,
    ownerEntityType VARCHAR(255) NOT NULL,
    createdById VARCHAR(255) NOT NULL,
    createdAt BIGINT UNSIGNED NOT NULL,
    updatedAt BIGINT UNSIGNED NOT NULL,
    PRIMARY KEY (id),
    KEY ownerEntityType (ownerEntityType),
    KEY updated (updatedAt)
  );
